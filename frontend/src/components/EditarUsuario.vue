          ...
          <div class="col-sm-10 has-validation">
            <div class="input-group mb-3">
              ...
              <input type="text" id="numeroDocumento" class="form-control border-input"
                v-model="users.id" placeholder="Número de Documento" minlength="6" maxlength="10" disabled required />
          ...
          <div class="col-sm-10 has-validation">
            <div class="input-group mb-3">
              ...
              <input type="password" class="form-control border-input" placeholder="Password" aria-label="Password"
                aria-describedby="basic-addon1" v-model="users.password" minlength="8" maxlength="20" disabled required />
              <div class="invalid-feedback">
