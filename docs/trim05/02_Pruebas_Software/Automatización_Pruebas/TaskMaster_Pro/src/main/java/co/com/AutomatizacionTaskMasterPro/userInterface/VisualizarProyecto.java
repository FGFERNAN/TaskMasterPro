...
public class VisualizarProyecto extends PageObject {
        ...
        public static Target VIS_PROYECTOS = Target.the("Visualizar un proyecto").located(By.xpath("/html/body/div/div/div/div[2]/div/div[1]/ul/li[4]/ul/li/div/a"));
        ...
        public static final Target PORCENTAJE = Target.the("Visualización de porcentaje").located(By.xpath("/html/body/div/div/div/div[2]/div/div[2]/section/div[1]/div[4]/div/div"));
