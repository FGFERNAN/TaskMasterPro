...
public class AsignacionMiembro extends PageObject {
    ...
    public static Target BTN_AGREGAR = Target.the("Boton de agregar").located(By.id("1234567890"));
    public static Target MIEMBRO_AGREGADO = Target.the("Texto de confirmacion de miembro agregado").located(By.id("user-1234567890"));
    public static Target BTN_ELIMINAR = Target.the("Boton para eliminar miembro").located(By.id("btn-1234567890"));
