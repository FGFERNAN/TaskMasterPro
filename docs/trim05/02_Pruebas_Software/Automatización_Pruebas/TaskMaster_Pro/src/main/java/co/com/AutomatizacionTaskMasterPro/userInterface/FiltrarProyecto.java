...
public class FiltrarProyecto {
    ...
    public static Target TEXTO_CONFIRMACION = Target.the("Confirmacion del proyecto filtrado").located(By.xpath("/html/body/div/div/div/div[2]/div/div[2]/section/div[1]/div[1]/h2"));
