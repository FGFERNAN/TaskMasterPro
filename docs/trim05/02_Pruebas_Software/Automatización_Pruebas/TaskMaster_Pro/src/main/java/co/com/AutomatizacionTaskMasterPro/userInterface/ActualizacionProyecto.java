...
public class ActualizacionProyecto extends PageObject {
    ...
    public static Target TEXTO_CONFIRMACION = Target.the("Texto de confirmacion de cambios en el proyecto").located(By.xpath("/html/body/div/div/div/div[2]/div/div[2]/section/div[1]/div[1]/h2"));
