...
public class CrearProyecto {
    ...
    public static Target BTN_FECHAINICIO = Target.the("").located(By.xpath("//*[@id=\"logo\"]/h1/a"));
    public static Target BTN_FECHAFIN = Target.the("").located(By.xpath("//*[@id=\"logo\"]/h1/a"));
    ...
    public static Target CONFIRMACION_CREARP = Target.the("Interfaz Principal").locatedBy("//*[@id=\"app\"]/div/div[2]/div/div[2]/header/div[2]/h3/span");
}