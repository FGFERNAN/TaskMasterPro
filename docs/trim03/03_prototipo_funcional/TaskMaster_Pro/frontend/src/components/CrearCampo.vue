        ...
        <div class="col-sm-10 has-validation">
          <div class="input-group mb-3">
            <span class="input-group-text border-input">
              <svg xmlns="http://www.w3.org/2000/svg" width="17" height="16" fill="currentColor"
            ...
            <input type="text" class="form-control border-input" placeholder="Name" maxlength="50" required>
      ...
      <div class="row mb-3">
        ...
        <div class="col-sm-10">
          <div class="input-group mb-3">
            ...
            <select class="form-select border-input" id="tipo-campo" required>
      ...
      <div class="row mb-3">
        ...
        <div class="col-sm-10 has-validation">
          <div class="input-group mb-3">
            ...
            <input type="text" class="form-control border-input" id="valor-campo" placeholder="Value" required>
